...
page = st.sidebar.radio(                                                         
  ...
  ("CRYPTO ANALYSIS", "BIST ANALYSIS", "SINGLE ANALYSIS")      # radio metodu yuvarlak seçenek seçtirerek ayrı ayrı sayfalar oluşturuyor.  
)
